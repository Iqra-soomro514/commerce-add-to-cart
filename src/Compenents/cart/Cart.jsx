            ...
            item?.map((item) => {
              return (
                <Box className='w-100 position-relative'>
                  <Box className="mx-4 border- py-2 my-1 d-flex justify-content-between align-items-center">
                  ...
                  <Box sx={{ width: 250 }} className='d-flex justify-content-between align-items-center bg-body-warning p-3 position-fixed bottom-0'>
