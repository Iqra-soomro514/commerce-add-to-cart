          ...
          >
            {product?.map((item, index) => {
              return (
                ...
                >
                  <Card key={index} sx={{ width: "455px", minWidth: "280px" }}>
                    <CardActionArea>
                      ...
                      <CardContent className="d-flex justify-content-between align-items-center bg-gradient">
                    ...
                    <Divider sx={{ borderColor: "danger" }} />
                    <CardActions>
                      <Box className="d-flex justify-content-between align-items-center w-100 py-1 bg-warning">
                        <Tooltip title=" View details">
                          <VisibilityIcon
                            ...
                            className="fs-1 p-2  btn-warning "
                            sx={{
                            }}
                          />
                        </Tooltip>
                        ...
                        <Tooltip title="Add to cart">
                          <ShoppingCartIcon
                            ...
                            className="fs-1 py-1 w-50 rounded-pill btn-warning"
                            onClick={() => {
                        ...
                        <Tooltip title="Favorite">
                          <FavoriteBorderIcon
                            className="fs-1 p-2 btn btn-warning rounded-circle"
                            sx={{
